...
# - Preserve modification times (--times/-t) to retain original file dates
...
RSYNC_FLAGS=(-rltD --no-perms --no-owner --no-group --omit-dir-times --info=stats2 --itemize-changes --stats)
